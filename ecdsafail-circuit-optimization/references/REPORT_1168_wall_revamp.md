...
- The `trailmix_ludicrous` module is now the **base to fork from**, not the dialog-GCD 1168 route. SOTA = `d11bdbb`/`88ed0f5`, **1159q × 1,380,711 = 1,600,244,049** (cheap Karatsuba arithmetic + the 1159q headroom clamp, fold-vents off).
